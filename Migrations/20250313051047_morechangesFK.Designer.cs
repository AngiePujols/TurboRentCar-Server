...
namespace TurboRentCar.Migrations
{
    ...
    [Migration("20250313051047_morechangesFK")]
    partial class morechangesFK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TurboRentCar.Entities.Vehiculo", b =>
                {
                    ...
                    b.Property<int?>("TipoCombustibleId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TurboRentCar.Entities.Modelos", b =>
                {
                    ...
                    b.HasOne("TurboRentCar.Entities.Marcas", null)
                        .WithMany("Modelos")
            ...
            modelBuilder.Entity("TurboRentCar.Entities.Vehiculo", b =>
                {
                    ...
                    b.HasOne("TurboRentCar.Entities.Modelos", "Modelo")
                        .WithMany()
                    ...
                    b.HasOne("TurboRentCar.Entities.TipoCombustible", null)
                        .WithMany("Vehiculo")
                        .HasForeignKey("TipoCombustibleId1");
